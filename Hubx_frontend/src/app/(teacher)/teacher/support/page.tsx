...
export default function TeacherSupportPage() {
    ...
    const faqs = [
        {
            id: 1,
            question: "How do I create and publish a paper?",
            answer: "Go to the Papers section, click 'Create New Paper', select your subject and chapters, add questions (manually or via AI), configure settings, and click 'Publish'. Once published, it will be visible to students.",
        },
        {
            id: 2,
            question: "Can I edit a paper after publishing it?",
            answer: "No, published papers cannot be edited. However, you can unpublish the paper, make edits, and republish it. This won't affect student attempts already made.",
        },
        {
            id: 3,
            question: "How do I add questions from my Question Bank?",
            answer: "Create a Question Bank for your subject, add questions with details, and then when creating a paper, you can select 'Add from Bank' to reuse existing questions.",
        },
        {
            id: 4,
            question: "How does the AI assessment generator work?",
            answer: "Select your subject, chapters, and difficulty level. The AI will generate questions automatically. You can review, edit, or regenerate before publishing.",
        },
        {
            id: 5,
            question: "Can I set a price for my papers?",
            answer: "Yes, you can make papers free or paid. Set the price in the paper settings. Students will need to purchase before accessing paid papers.",
        },
        {
            id: 6,
            question: "How do I view student performance on my papers?",
            answer: "Go to Analytics to see detailed reports on student performance, average scores, common mistakes, and time spent on each question.",
        },
        {
            id: 7,
            question: "What file formats can I upload for questions?",
            answer: "You can upload images (JPG, PNG, etc.), PDFs, and ODF documents for question images and solutions.",
        },
        {
            id: 8,
            question: "How do I manage coupons for discounts?",
            answer: "In the paper settings, you can generate and manage coupon codes. Students can apply these codes during purchase for discounts.",
        },
    ];
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            ...
            <div className="text-center">
                ...
                <p className="text-gray-500 mt-2">We're here to help you create amazing assessments</p>
            </div>
