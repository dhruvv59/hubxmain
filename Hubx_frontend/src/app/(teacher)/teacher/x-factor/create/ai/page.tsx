...
function AiGeneratorPageContent() {
    ...
    const handleGenerate = async (count: number, instructions: string) => {
        ...
        try {
            ...
            success(`AI successfully generated ${generatedQuestions.length} questions!`);

        } catch (err: any) {
            console.error("AI Generation failed:", err);
            const errorMsg = err?.message || "Failed to generate questions. Please check your request and try again.";
            error(errorMsg);
        } finally {
    ...
    const handleConfirmPublish = async () => {
        if (!draftId) {
            ...
            error("No draft found. Please try again.");
            return;
        }
        ...
        try {
            ...
            const errorMsg = err?.message || "Failed to publish paper. Please try again.";
            error(errorMsg);
        } finally {
