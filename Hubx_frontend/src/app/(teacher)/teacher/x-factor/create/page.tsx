            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1 w-full bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                    ...
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                        ...
                        <button
                            onClick={() => router.push(`/teacher/x-factor`)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <MethodCard
                            type="manual"
                            onClick={() => router.push(`/teacher/x-factor/create/manual?draftId=${draftId}`)}
                        />
                        <MethodCard
                            type="bulk"
                            onClick={() => router.push(`/teacher/x-factor/create/bulk?draftId=${draftId}`)}
                        />
                        <MethodCard
                            type="ai"
                            onClick={() => router.push(`/teacher/x-factor/create/ai?draftId=${draftId}`)}
                        />
                    </div>
                </div>
            </div>
