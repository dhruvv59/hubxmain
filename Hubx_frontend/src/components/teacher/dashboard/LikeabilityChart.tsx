...
export function LikeabilityChart({ data: initialData }: LikeabilityChartProps) {
    ...
    const filterData = (period: TimePeriod, range: DateRange) => {
        ...
        try {
            ...
            console.error('Error filtering likeability data:', err);
        } finally {
            setIsLoading(false);
        }
    };
